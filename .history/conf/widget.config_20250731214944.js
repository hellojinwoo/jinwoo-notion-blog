...
module.exports = {
  ...
  // 페이스북 팬 페이지를 보여주는 작은 플러그인 @see https://tw.andys.pro/article/add-facebook-fanpage-notionnext
  FACEBOOK_PAGE_TITLE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_TITLE || null, // 사이드바 Facebook Page 위젯의 제목 표시줄, ''로 설정하면 제목 표시줄 없음 예: FACEBOOK 팬페이지
  FACEBOOK_PAGE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE || null, // Facebook Page 링크 예: https://www.facebook.com/tw.andys.pro
