...
module.exports = {
  ...
  ANALYTICS_BUSUANZI_ENABLE:
    process.env.NEXT_PUBLIC_ANALYTICS_BUSUANZI_ENABLE || true, // 웹사이트 읽기 수, 방문 수 표시 see http://busuanzi.ibruce.info/
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '', // e.g 바이두 통계 id만 입력하면 됩니다, [baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 사이트 관리자 통계 id만 입력하면 됩니다, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '', // id, 51la 관리자 페이지에서 획득 참조 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '', // ck, 51la 관리자 페이지에서 획득
  ...
  // 마이크로소프트 Clarity 사이트 분석
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || null // Clarity 스크립트의 ID 부분만 복사하면 됩니다, ID는 10자리 영문 숫자 조합입니다
